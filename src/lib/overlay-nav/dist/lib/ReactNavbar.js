...
const ReactNavbar = (_ref) => {
    ...
    (0, _react.useEffect)(() => {
        ...
        logoRef.current.addEventListener("mouseover", () => {
            logoRef.current.style.filter = "drop-shadow(0 0 "
                .concat(logoHoverSize, " ")
                .concat(logoHoverColor, ")");
        });
                ...
                /*#__PURE__*/ _react.default.createElement("img", {
                    ...
                    style: {
                        ...
                        animation: menuToggle
                            ? "LogoleftIn ".concat(logoAnimationTime, "s")
                            : "LogoleftOut ".concat(logoAnimationTime, "s"),
                    },
                    ref: logoRef,
                    alt: "Not Passed",
                })
                ...
                /*#__PURE__*/ _react.default.createElement(
                    _reactRouterDom.Link,
                    {
                        ...
                        style: {
                            ...
                            animation: menuToggle
                                ? "LinkIn ".concat(link1AnimationTime, "s")
                                : "LinkOut ".concat(link1AnimationTime, "s"),
                        },
                        to: link1Url,
                ...
                /*#__PURE__*/ _react.default.createElement(
                    _reactRouterDom.Link,
                    {
                        ...
                        style: {
                            ...
                            animation: menuToggle
                                ? "LinkIn ".concat(link2AnimationTime, "s")
                                : "LinkOut ".concat(link2AnimationTime, "s"),
                        },
                        to: link2Url,
                        onClick: closeBarOnClick,
                    },
                ...
                /*#__PURE__*/ _react.default.createElement(
                    _reactRouterDom.Link,
                    {
                        ...
                        style: {
                            ...
                            animation: menuToggle
                                ? "LinkIn ".concat(link3AnimationTime, "s")
                                : "LinkOut ".concat(link3AnimationTime, "s"),
                        },
                        to: link3Url,
                        onClick: closeBarOnClick,
                    },
                ...
                /*#__PURE__*/ _react.default.createElement(
                    _reactRouterDom.Link,
                    {
                        ...
                        style: {
                            ...
                            animation: menuToggle
                                ? "LinkIn ".concat(link4AnimationTime, "s")
                                : "LinkOut ".concat(link4AnimationTime, "s"),
                        },
                        to: link4Url,
                        onClick: closeBarOnClick,
                    },
                    ...
                    ? /*#__PURE__*/ _react.default.createElement(
                          ...
                          /*#__PURE__*/ _react.default.createElement(
                              ProfileIconElement,
                              {
                                  ...
                                  style: {
                                      transition: "all ".concat(
                                          profileIconTransition,
                                          "s"
                                      ),
                                      margin: profileIconMargin,
                                      animation: menuToggle
                                          ? "IconIn ".concat(
                                                profileIconAnimationTime,
                                                "s"
                                            )
                                          : "IconOut ".concat(
                                                profileIconAnimationTime,
