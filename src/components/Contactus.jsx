...
const Contactus = () => {
    return (
        <>
            <div className="bg-[#020005] max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-1 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  text-gray-900 rounded-lg shadow-lg">
